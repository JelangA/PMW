...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb" style="background: transparent; font-size: 16px; padding: 3px 2px; margin-bottom: 0px;">
        ...
        <li class="breadcrumb-item active"><a href="/master/carousel">Mading</a></li>
    </ol>
</nav>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="col">
                        <p style="font-size: 15pt; font-weight: 700; margin-bottom: 0px;">Mading Data</p>
                    </div>
                    <div class="col">
                        <a href="{{ route('carousel.create') }}" class="btn btn-primary float-right">
                            <span class="fas fa-plus"></span> {{ __('Upload Photo') }}
                        </a>
                    </div>
                </div>
