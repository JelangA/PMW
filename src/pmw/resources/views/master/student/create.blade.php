...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb" style="background: transparent; font-size: 16px; padding: 3px 2px; margin-bottom: 0px;">
        ...
        <li class="breadcrumb-item active"><a style="color: black;" href="/master/student">Mahasiswa</a></li>
        <li class="breadcrumb-item active"><a href="/master/student/create">Tambah Data</a></li>
    </ol>
</nav>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <p style="font-size: 15pt; font-weight: 700; margin-bottom: 0px;">Tambah Data Mahasiswa</p>
                </div>
                <form action="{{ route('student.store') }}" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" value="{{ old('nim') }}" id="nim" name="nim" class="form-control" required="" placeholder="Masukkan NIM ...">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" value="{{ old('year') }}" id="year" name="year" class="form-control" required="" placeholder="Masukkan Angkatan ...">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="password" id="password" name="password" class="form-control pwstrength" data-indicator="pwindicator" placeholder="Masukkan Kata Sandi ...">
                                </div>
