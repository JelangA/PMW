...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb" style="background: transparent; font-size: 16px; padding: 3px 2px; margin-bottom: 0px;">
        ...
        <li class="breadcrumb-item active"><a href="/master/verif">Proposal Diverifikasi</a></li>
    </ol>
</nav>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <p style="font-size: 15pt; font-weight: 700; margin-bottom: 0px;">Data Proposal Diverifikasi</p>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="crudProposalVerif" class="table table-striped w-100">
                            <thead>
                                <tr>
...
@push('scripts')
    <script>
        var datatable = $('#crudProposalVerif').DataTable({
            processing: true,
            serverSide: true,
