...
<html>
    ...
    <body>
        <p>Password telah berhasil diubah oleh administrator, silahkan gunakan password terbaru untuk masuk ke dalam aplikasi.</p>
        ...
        <table>
            <tr>
                ...
                <td class="value">{{ $details['nim'] }}</td>
            </tr>
            <tr>
                <td class="title">Nama</td>
                <td class="value">{{ $details['nama'] }}</td>
            </tr>
            <tr>
                <td class="title">Tahun Masuk</td>
                <td class="value">{{ $details['tahun_masuk'] }}</td>
            </tr>
            <tr>
