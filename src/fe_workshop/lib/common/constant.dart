...
Color primaryColor = const Color(0xFF394EEA);
Color secondaryColor = const Color(0xFF43afc8);
Color successColor = const Color(0xff00DD85);
Color greenColor = const Color(0xFF02A520);
Color failedColor = const Color(0xffFF2A44);
